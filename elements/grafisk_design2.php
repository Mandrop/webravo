...
<div class="container-fluid p-0 grafisk-design">

    <div class="container-fluid bg-webravo-blue p-5 d-flex flex-column justify-content-center grafisk-design-skew2 text-white">
        <article class="grafisk-design-skew-back2 my-5">
            <h1 class="text-center">Hjemmeside udvikling</h1>
